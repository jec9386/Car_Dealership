...
public class DealershipFileManager {
    ...
    public static Dealership getDealership(){//return a Dealership object
        ...
        try(FileReader fileReader = new FileReader(fileName); BufferedReader reader = new BufferedReader(fileReader)){
            ...
            String line;//read the first line of the file,pipe is used to distinguish which variable the value belongs to, values used to create a new Dealership object
            if((line = reader.readLine()) != null){//readLine() reads 1 line of text from file, if there is a line it stores it in line variable- keep reading until there is no more lines.
                String[] parts = line.split("\\|"); //dealership info
                String name = parts[0];
